...
def train_continuity_calibrator(examples: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    passed = validation["passed"] and {"accept_continuity", "reject_continuity"}.issubset(set(labels))
    return {
        "artifact": "m5_4d_continuity_calibrator",
        "model_type": "match_local_short_window_probability_calibrator",

...
def test_baseline_registry_rehash_passes_after_capture(tmp_path: Path) -> None:
    ...
    report = json.loads((run_dir / "validation/registry_integrity_report.json").read_text(encoding="utf-8"))

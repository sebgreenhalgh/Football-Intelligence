...
def test_capture_writes_to_external_artifact_root(tmp_path: Path) -> None:
    ...
    assert run_dir.parent == artifact_root / "matches/128058/runs/step_m5/02_infrastructure_hardening/runs"
